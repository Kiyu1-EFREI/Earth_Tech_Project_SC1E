...
def init_lvl_menu(police):
    element = [
        ...
        ButtonClass(pygame.Rect(195, 320, 200, 200), "1", pygame.font.Font(None, 200), 1, (0, 160, 0), 8, (0, 220, 0)),
        ButtonClass(pygame.Rect(425, 320, 200, 200), "2", pygame.font.Font(None, 200), 2, (0, 160, 0), 8, (0, 220, 0)),
        ButtonClass(pygame.Rect(655, 320, 200, 200), "3", pygame.font.Font(None, 200), 3, (0, 160, 0), 8, (0, 220, 0)),
        ButtonClass(pygame.Rect(885, 320, 200, 200), "4", pygame.font.Font(None, 200), 4, (0, 160, 0), 8, (0, 220, 0)),
