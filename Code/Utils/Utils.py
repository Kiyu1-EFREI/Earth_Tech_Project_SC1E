    ...
    for key, val in element.items():
        for i in val:
            ...
            if key == "platform":
                ...
                rect[-1].frame = [pygame.transform.scale(pygame.image.load("./Asset/maps/poubelle_plastique.png").convert_alpha(), (50, 50))]

            elif key == "poubelle_verre":
                rect[-1].frame = [pygame.transform.scale(pygame.image.load("./Asset/maps/poubelle_verre.png").convert_alpha(), (50, 50))]

            elif key == "poubelle_reste":
                rect[-1].frame = [pygame.transform.scale(pygame.image.load("./Asset/maps/poubelle_reste.png").convert_alpha(), (50, 50))]
